...
## [8.3.4] - 2026-01-11 - FFXIV Recorder
### Added
- Re-added ennemy marking before actually deleting to try not to consider certain phases dps check as bosses

## [8.3.3] - 2026-01-11 - FFXIV Recorder
### Changed
- Combat start now based on engage timer event as even ff act timestamp are not the same for everyone (should be close enough, can't be more in sync with the date we have here)
...
## [8.3.0] - 2026-01-11 - FFXIV Recorder
### Added
- New combatant number check after the end of recording to discard less than 8 players fights
### Fixed
- Sync with FF server time was the wrong way around, now applies the offset correctly

## [8.2.0] - 2026-01-10 - FFXIV Recorder
### Changed
- Using realm variable to pass job name through cloud (was not using realm before with ffxiv so repurposing)
...
## [7.3.0] 2025-05-27
### Added
- Offset between local system and server offset checks to be able to sync fight start and deaths as much as possible
