...
const ENGLISH: Translations = {
  ...
  [Phrase.PlayerNameDescription]: 'The player name, cannot be YOU',
  ...
  [Phrase.CloudUploadRetailDescription]: 'If FFXIV recordings should be uploaded to the cloud.',
  ...
  [Phrase.PlayerNameLabel]: 'Player name',
  ...
  [Phrase.CloudUploadRetailLabel]: 'Upload FFXIV',
  ...
  [Phrase.StatusDescriptionRecording]: 'FFXIV Recorder is currently recording',
  ...
  [Phrase.StatusDescriptionWaiting]: 'Waiting for FFXIV to start',
  [Phrase.StatusDescriptionConfiguredToRecord]: 'FFXIV Recorder is configured to record',
  [Phrase.StatusDescriptionMisconfigured]: 'FFXIV Recorder is misconfigured',
  [Phrase.StatusDescriptionResolveError]: 'Please resolve the error below',
  [Phrase.StatusDescriptionDetectedRunning]: 'Detected FFXIV is running',
  [Phrase.StatusDescriptionWatchingLogs]: 'FFXIV Recorder is waiting for a recordable event to be sent by FFXIV Recorder overlay plugin',
  ...
  [Phrase.StatusDescriptionFatalError]: 'FFXIV Recorder has hit a fatal error',
  ...
  [Phrase.StatusDescriptionOverrunning]: 'FFXIV Recorder has detected an activity has completed successfuly and is recording a few seconds extra to catch the aftermath.',
  ...
  [Phrase.ErrorPlayerNameYou]: "PlayerName must not be empty nor \"YOU\"",
  ...
  [Phrase.InvalidFFXIVLogPath]: 'Invalid ffxiv log path.',
  ...
  [Phrase.RecordXIVDescription]: 'Whether the application should record FFXIV. You should probably turn this on as this is the only game supported',
  [Phrase.XIVLogPathDescription]: 'Location of the FFXIV logs folder, corresponds to the ACT logs folder, e.g. "C:\\Users\\username\\AppData\\Roaming\\Advanced Combat Tracker\\FFXIVLogs".',
  ...
  [Phrase.XIVLogPathLabel]: 'FFXIV Log Path',
